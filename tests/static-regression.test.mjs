...
assertIncludes(dashboard, 'product?.name || barcode', 'dashboard order export should include product name');
assertIncludes(dashboard, 'Number(item.price || 0)', 'dashboard order export should include item price');
...
assert.ok(!dashboard.includes("order.order_no || ''"), 'dashboard order export should not include order number');
